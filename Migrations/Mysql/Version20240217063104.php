...
use cweagans\Composer\Tests\PatchEventTest;
...
final class Version20240217063104 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        if (!$this->connection->getDriver()->getSchemaManager($this->connection)->tablesExist('kaystrobach_contact_domain_model_userinstitutionrelationship')) {
